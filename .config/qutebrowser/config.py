...
## Type: Dict
c.url.searchengines = {
    'DEFAULT': 'https://zoek.anchel.nl/search?q={}',
...
c.url.start_pages = ['file:///home/user1/.config/home.html']
...
config.bind('<Ctrl-Space>', 'spawn --userscript addbm')
